...
# Create interaction features between all pairs of columns
...
data['location_milage'] = data['location'] + '_' + data['milage']
data['company_engine'] = data['company'] + '_' + data['engine']
data['company_milage'] = data['company'] + '_' + data['milage']
data['engine_milage'] = data['engine'] + '_' + data['milage']
...
categorical_features = [
    'location', 'company', 'location_operation_time', 'engine', 'milage',
    'location_company', 'location_engine', 'location_milage', 'company_engine',
    'company_milage', 'engine_milage'
]
numerical_features = ['operation_time','milage']
